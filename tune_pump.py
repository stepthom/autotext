...
def main():    
    ...
    train_fn = None
    test_fn = None
    if args.keep_top_id == 1:
        train_fn = "pump/data/pump_train_e3c1b0ed-6669-4927-971b-9cbfcd355ca4.csv"
        test_fn = "pump/data/pump_test_e3c1b0ed-6669-4927-971b-9cbfcd355ca4.csv"
    elif args.keep_top_id == 2:
        train_fn = "pump/data/pump_train_994af52f-d46d-40a3-a471-a25b615c2ba2.csv"
        test_fn = "pump/data/pump_test_994af52f-d46d-40a3-a471-a25b615c2ba2.csv"
    elif args.keep_top_id == 3:
        train_fn = "pump/data/pump_train_a03c8867-3309-44bf-a6ac-5420c0bd887a.csv"
        test_fn = "pump/data/pump_test_a03c8867-3309-44bf-a6ac-5420c0bd887a.csv"
